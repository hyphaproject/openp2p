...
function(generate_template_export_header target target_id export_file)
    if ("${CMAKE_CXX_COMPILER_ID}" MATCHES "MSVC")
        configure_file(${PROJECT_SOURCE_DIR}/source/codegeneration/openp2p_msvc_api.hpp.in ${CMAKE_CURRENT_BINARY_DIR}/${export_file})
    else()
        configure_file(${PROJECT_SOURCE_DIR}/source/codegeneration/openp2p_api.hpp.in ${CMAKE_CURRENT_BINARY_DIR}/${export_file})
    endif()
endfunction()
